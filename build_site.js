...
section("intern-day1", "День перший", `
  ...
  ${table(["Тема заняття", "Розділ сайту"], [
    ...
    progRow(["Головні промислові об'єкти зони ККАМЛР", "<a href=\"06-identification.html\">Визначники</a> (іклач), <a href=\"17-other-fisheries.html\">Інші промисли</a> (криль, кальмари, краби)"]),
    progRow(["Знаряддя лову й промисел іклача, криля, кальмарів, крабоідів", "<a href=\"05-gear.html\">Знаряддя лова</a>, <a href=\"17-other-fisheries.html\">Інші промисли</a>"]),
...
section("intern-day2", "День другий — Науковий спостерігач: права, обов'язки, завдання", `
  ${table(["Тема заняття", "Розділ сайту"], [
    ...
    progRow(["Облік цільових видів і прилову (іклач, криль, кальмари, крабоіди)", "<a href=\"04-forms-instructions.html\">Форми та інструкції</a>, <a href=\"17-other-fisheries.html\">Інші промисли</a>"]),
    progRow(["Аналіз іклача: стадії зрілості гонад, гістологічні дані", "<a href=\"06-identification.html\">Визначники</a> (частково — детальний гістологічний протокол не описано)"]),
    ...
    progRow(["Методика й норми мічення іклача", "<a href=\"08-tagging.html\">Мічення (Tagging)</a>"]),
